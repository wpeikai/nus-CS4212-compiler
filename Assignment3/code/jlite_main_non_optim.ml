...
open Ir3_structs
open Jlite_toir3_non_optim
open Ir3_to_arm_non_optim
open Arm_structs
...
let process file_name prog  = 
	begin
		...
		let ir3prog = Jlite_toir3_non_optim.jlite_program_to_IR3 typedprog in
		(* print_string (Ir3_structs.string_of_ir3_program ir3prog); *)
		let armprog = Ir3_to_arm_non_optim.ir3_program_to_arm ir3prog in
